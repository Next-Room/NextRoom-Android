...
import com.nextroom.nextroom.presentation.ui.password.CheckPasswordViewModel
import com.nextroom.nextroom.presentation.ui.tutorial.timer.compose.CodeInputSection

@Composable
fun CheckPasswordScreen(
    state: CheckPasswordViewModel.UiState,
    onKeyClick: (Int) -> Unit,
    ...
    Box(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                Text(
                    text = stringResource(R.string.text_input_password_header),
                    style = NRTypo.Poppins.size24,
                    color = NRColor.White
                )
                Spacer(modifier = Modifier.height(12.dp))
                Text(
                    text = stringResource(R.string.text_input_password_description),
...
@Composable
private fun CheckPasswordScreenPreview() {
    CheckPasswordScreen(
        state = CheckPasswordViewModel.UiState(input = "12", inputState = InputState.Typing),
        onKeyClick = {},
        onBackspaceClick = {},
        onBackClick = {},
        onBiometricClick = {},
...
@Preview(showBackground = true, backgroundColor = 0xFF151516, heightDp = 720)
@Composable
private fun CheckPasswordScreenErrorPreview() {
    CheckPasswordScreen(
        state = CheckPasswordViewModel.UiState(
            input = "",
